...
class NotificationService {
  ...
  Future<void> onAppPublished({
    ...
    await _send(
      ...
      AppNotification(
        ...
        title: 'App Published',
        message:
            'Your app "$appName" has been published and is now open for testers.',
  ...
  Future<void> onMaxTestersReached({
    ...
    await _send(
      ...
      AppNotification(
        ...
        message:
            '"$appName" testing is complete. $totalTesters testers joined. '
  ...
  Future<void> onUserJoinedGroup({
    required List<RoomMember> existingMembers,
