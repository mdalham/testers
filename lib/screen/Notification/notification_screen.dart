...
import 'package:testers/controllers/app_routes.dart';
import 'package:testers/screen/Notification/service/notification_model.dart';
import 'package:testers/screen/Notification/service/notification_provider.dart';
import 'package:testers/screen/Notification/sheet/notification_detail_sheet.dart';
...
class NotificationScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Use uid (not username) — matches users/{uid}/notifications path
...
// ─────────────────────────────────────────────────────────────────────────────
// _TypeChip  — small pill that identifies the category
// ─────────────────────────────────────────────────────────────────────────────
