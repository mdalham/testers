...
import '../../widget/badge/notification_badge.dart';
...
class _NavTileState extends State<_NavTile> {
  ...
  Widget build(BuildContext context) {
    ...
    // ── Icon: with badge dot for notification tile ─────────────────────────
    // FIX: use uid (not username) — matches users/{uid}/notifications path.
