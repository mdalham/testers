...
// Use an alias so our AuthProvider never collides with firebase_auth's AuthProvider
import '../../../controllers/height_width.dart';
import '../../../service/provider/auth_provider.dart' as app;
...
//  Usage: AuthDialogs.showForgotPassword(context);
// ══════════════════════════════════════════════════════════════════════════════
...
// ══════════════════════════════════════════════════════════════════════════════
//  SetUsernameDialog
//  Usage: AuthDialogs.showSetUsername(context, auth: auth);
// ══════════════════════════════════════════════════════════════════════════════
class SetUsernameDialog extends StatefulWidget {
  const SetUsernameDialog({super.key, required this.auth});

  /// app.AuthProvider — NOT firebase_auth's AuthProvider.
