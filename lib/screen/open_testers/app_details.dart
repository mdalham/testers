...
import 'package:testers/screen/open_testers/publish_app/app_listing_screen.dart';
import 'package:testers/screen/open_testers/publish_app/step5_success.dart';
import 'package:testers/screen/open_testers/testing_progress_bottom_sheet.dart';
import 'package:testers/screen/open_testers/update/app_info_card.dart';
...
class _AppDetailsScreenState extends State<AppDetailsScreen> {
  ...
  void initState() {
    ...
    // In _AppDetailsScreenState.initState(), after _isOwner check:
...
class _AppHeaderCard extends StatelessWidget {
  const _AppHeaderCard({
    ...
    required this.isBoosted, // ✅ was isFeatured
    required this.appId,
    this.appIconUrl,
  });
