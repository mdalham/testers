...
import '../../logic/testing_logic.dart';
...
import '../../widget/container/testing_feedback_form.dart';
...
class TestingProgressBottomSheet extends StatefulWidget {
  ...
  /// Provided automatically when shown via [show]; enables drag-to-resize.
...
class _TestingProgressBottomSheetState
  ...
  Future<void> _claimCoins() async {
    ...
    await TestingLogic.instance.claimCoins(
      ...
      screenshotUrl: _screenshotUrl!, // ← passed
      issueType: _selectedIssue, // ← passed
      feedbackNote:
          _reportCtrl.text
              .trim()
              .isEmpty // ← passed
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      // ── Scrollable body driven by DraggableScrollableSheet's controller ──
      child: CustomScrollView(
        // Falls back to a plain controller when used without DraggableScrollableSheet
...
// ─────────────────────────────────────────────────────────────────────────────
//  Step Tile — with optional inline content
// ─────────────────────────────────────────────────────────────────────────────
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // ── Inline content (screenshot / feedback) ─────────────────
