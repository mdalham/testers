...
import 'package:testers/models/app_item.dart';
import 'package:testers/screen/discovery/update/update_service.dart';
...
import 'package:testers/widgets/list tile/app_grid_card.dart';
import 'package:testers/widgets/list tile/app_list_tile.dart';
...
import '../settings/room_join_sheet.dart';

const _kGroupSheetShown = 'group_joining_sheet_shown';

class Discovery extends StatefulWidget {
  const Discovery({super.key, this.welcomeName});
...
class _DiscoveryState extends State<Discovery> {
  ...
  Future<void> _maybeShowGroupSheet() async {
    ...
    showModalBottomSheet(
      ...
      builder: (_) => const RoomJoiningSheet(
