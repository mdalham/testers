...
import 'package:testers/services/room_service.dart';
import 'package:provider/provider.dart';

import '../../constants/info.dart';
import '../../services/firebase/CoinTransaction/coin_transaction_service.dart';
import '../../services/upload/image_upload.dart';
import '../../utils/height_width.dart';
import '../../widgets/button/custom_buttons.dart';
import '../../widgets/container/icon_upload_box.dart';
import '../../widgets/snackbar/custom_snackbar.dart';
import '../../widgets/test field/custom_text_formField.dart';
...
class _RoomJoinScreenState extends State<RoomJoinScreen> {
  ...
  Future<void> _submit() async {
    ...
    if (widget.existingGroupId != null) {
      error = await RoomService.instance.joinGroup(
      ...
      error = await RoomService.instance.createGroup(
        uid:        widget.uid,
        username:   widget.username,
        appDetails: appDetails,
      );
