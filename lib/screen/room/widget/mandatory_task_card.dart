...
import 'package:testers/screen/room/sheet/testing_bottom_sheet.dart';
...
class MandatoryTaskCard extends StatefulWidget {
  ...
  final void Function(ProofStatus status)? onStatusChanged;
...
class _MandatoryTaskCardState extends State<MandatoryTaskCard> {
  ...
  Future<void> _checkProof() async {
    final status = await RoomService.instance.getTodayProofStatus(
