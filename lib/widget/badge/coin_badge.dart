...
class _CoinDisplayState extends State<CoinDisplay>
  ...
  void initState() {
    ...
    )..repeat(); // spins while _loading is true
    ...
    // Start listening after first frame so context is available
    ...
    _coinSub = FirebaseFirestore.instance
        ...
        .listen(
          (snap) {
            ...
            // Also keep AuthProvider in sync so other widgets stay consistent
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Row(
        ...
        children: [
          // Spinning while loading, coin icon otherwise
          AnimatedSwitcher(
          ...
          // Animates whenever coins value changes
          AnimatedSwitcher(
