...
/// Controls the vertical padding and font size of the button.
...
class CustomElevatedBtn extends StatelessWidget {
  const CustomElevatedBtn({
    ...
    // ── Custom padding (overrides size.padding when provided) ─────────
    this.padding,
  });
  ...
  /// When set, overrides the padding derived from [size].
